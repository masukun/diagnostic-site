    ...
    return (
        <div>
            ...
            {(props.children === "どちらでもない") && (
                <li className="relative">
                    <input className="sr-only peer" type="radio" value="yes" name={`answer${props.index}`} id={`answer_maybe${props.index}`} onClick={() => {props.pointCalculate(props.children)}}/>
            ...
            {(props.children === "いいえ") && (
                <li className="relative">
                    <input className="sr-only peer" type="radio" value="yes" name={`answer${props.index}`} id={`answer_no${props.index}`} onClick={() => {props.pointCalculate(props.children)}}/>
