...
export default class App extends React.Component<{}, { questions: [],currentId: string,dataset:any,nextId:string}> {
    ...
    initQuestions = () => {
        ...
        const initQuestions = initDataset.questions;

        this.setState({questions:initQuestions});
    }
      ...
      py-0 px-[1rem] w-[100%] absolute top-[50%] left-[50%] translate-y-[-50%] translate-x-[-50%]">
                    ...
                    <div className="pt-[20px] flex justify-evenly">
                        <ul className="grid grid-cols-3 gap-x-5 m-10 max-w-md mx-auto">
                            ...
                            <div className="text-lg font-bold mt-[20px]">見栄や評価よりも実利を大切にする</div>
                            <div className="pt-[20px] flex justify-evenly">
                                <ul className="grid grid-cols-3 gap-x-5 m-10 max-w-md mx-auto">
                                    <li className="relative">
                                        <input className="sr-only peer" type="radio" value="yes" name="answer5" id="answer_yes5" />
                                        <label className="flex p-5 bg-white border border-gray-300 rounded-lg cursor-pointer focus:outline-none hover:bg-gray-50 peer-checked:ring-red-500 peer-checked:ring-2 peer-checked:border-transparent" htmlFor="answer_yes5">はい<br /><br /></label>
                                    </li>
                                    <li className="relative">
                                        <input className="sr-only peer" type="radio" value="maybe" name="answer5" id="answer_maybe5" />
                                        <label className="flex p-5 bg-white border border-gray-300 rounded-lg cursor-pointer focus:outline-none hover:bg-gray-50 peer-checked:ring-red-500 peer-checked:ring-2 peer-checked:border-transparent" htmlFor="answer_maybe5">どちらでもない</label>
                                    </li>
                                    <li className="relative">
                                        <input className="sr-only peer" type="radio" value="no" name="answer5" id="answer_no5" />
                                        <label className="flex p-5 bg-white border border-gray-300 rounded-lg cursor-pointer focus:outline-none hover:bg-gray-50 peer-checked:ring-red-500 peer-checked:ring-2 peer-checked:border-transparent" htmlFor="answer_no5">いいえ<br /><br /></label>
                                    </li>
                                </ul>
                            </div>
                            <div className="text-lg font-bold mt-[20px]">目標を達成するまで粘り強く行動できる</div>
                            <div className="pt-[20px] flex justify-evenly">
                                <ul className="grid grid-cols-3 gap-x-5 m-10 max-w-md mx-auto">
                                    <li className="relative">
                                        <input className="sr-only peer" type="radio" value="yes" name="answer6" id="answer_yes6" />
                                        <label className="flex p-5 bg-white border border-gray-300 rounded-lg cursor-pointer focus:outline-none hover:bg-gray-50 peer-checked:ring-red-500 peer-checked:ring-2 peer-checked:border-transparent" htmlFor="answer_yes6">はい<br /><br /></label>
                                    </li>
                                    <li className="relative">
                                        <input className="sr-only peer" type="radio" value="maybe" name="answer6" id="answer_maybe6" />
                                        <label className="flex p-5 bg-white border border-gray-300 rounded-lg cursor-pointer focus:outline-none hover:bg-gray-50 peer-checked:ring-red-500 peer-checked:ring-2 peer-checked:border-transparent" htmlFor="answer_maybe6">どちらでもない</label>
                                    </li>
                                    <li className="relative">
                                        <input className="sr-only peer" type="radio" value="no" name="answer6" id="answer_no6" />
                                        <label className="flex p-5 bg-white border border-gray-300 rounded-lg cursor-pointer focus:outline-none hover:bg-gray-50 peer-checked:ring-red-500 peer-checked:ring-2 peer-checked:border-transparent" htmlFor="answer_no6">いいえ<br /><br /></label>
                                    </li>
                                </ul>
                            </div> */}
                            <Link href="/question">
