...
import Girl from '../../public/images/pose_genki02_girl.png'
    ...
    return (
        <div>
          ...
          py-0 px-[1rem] w-[100%] absolute top-[50%] left-[50%] translate-y-[-50%] translate-x-[-50%]">
                        <h1 className="text-center text-xl ml-[65px]">あなたは素晴らしい人格の持ち主です。</h1>
                        <div>
                            <img src={Girl.src} className="ml-[70px]" width="320" height="200"></img>
                        </div>
                        <Link href="/">
